              ...
              <div className="p-6 sm:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full px-6 py-3 bg-pulse-500 hover:bg-pulse-600 text-white font-medium rounded-full transition-colors duration-300 flex items-center justify-center group"
                    >
                      Send Message
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="flex flex-col items-center space-y-4">
                <button
                  ...
                  className="flex items-center justify-center px-8 py-4 bg-white border-2 border-pulse-500 text-pulse-500 hover:bg-pulse-500 hover:text-white font-medium rounded-full transition-all duration-300 shadow-lg hover:shadow-xl group w-full max-w-xs"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center px-8 py-4 bg-[#0077B5] hover:bg-[#005885] text-white font-medium rounded-full transition-all duration-300 shadow-lg hover:shadow-xl group w-full max-w-xs"
                >
