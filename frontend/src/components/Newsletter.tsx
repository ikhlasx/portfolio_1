      ...
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-start md:items-center">
            ...
            <button type="submit" disabled={isSubmitting} className="bg-pulse-500 hover:bg-pulse-600 text-white font-medium py-4 px-10 rounded-full transition-all duration-300 ease-out hover:scale-105 active:scale-95 hover:shadow-xl active:shadow-md md:ml-4 disabled:opacity-50 disabled:cursor-not-allowed">
