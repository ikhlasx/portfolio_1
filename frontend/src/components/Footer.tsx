        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8">
              ...
              >
                <Mail className="w-5 h-5 group-hover:text-pulse-400" />
              ...
              <a 
                ...
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors group"
              >
                <Phone className="w-5 h-5 group-hover:text-pulse-400" />
              ...
              <a 
                ...
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors group"
              >
                <Linkedin className="w-5 h-5 group-hover:text-pulse-400" />
              ...
              <a 
                ...
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors group"
              >
                <Github className="w-5 h-5 group-hover:text-pulse-400" />
