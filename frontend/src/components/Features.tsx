...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    ...
    >
      <div className="rounded-full bg-pulse-50 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-pulse-500 mb-4 sm:mb-5 transition-all duration-300 ease-out group-hover:scale-110 group-hover:bg-pulse-100">
