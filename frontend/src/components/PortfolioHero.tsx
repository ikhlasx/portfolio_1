        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in" style={{ animationDelay: "0.7s" }}>
              ...
              >
                View GitHub
                <Github className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </a>
              <a 
            ...
            {lottieData ? (
              ...
              <>
                ...
                <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                  <img 
                    ref={imageRef} 
                    src="https://customer-assets.emergentagent.com/job_central-folio/artifacts/buyji37i_ikhlas%20new.jpg" 
                    alt="Ikhlas Portfolio Image" 
